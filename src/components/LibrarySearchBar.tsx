    ...
    <div className="flex items-center gap-3 mb-4">
      <div className="relative flex-1">
        ...
        <input
          ...
          className="w-full bg-bg-inset border border-black/10 rounded-xl pl-9 pr-8 py-2.5 text-sm text-text-primary placeholder:text-text-tertiary focus:border-accent-400/60 focus:outline-none transition-colors duration-150"
        />
        {value && (
          <button
            onClick={() => setValue('')}
