...
export default function NewChallengePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    e.preventDefault()
    setSaving(true)
    const res = await fetch('/api/admin/arcade/challenges', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ ...form, bundleId }),
    })
    if (res.ok) {
  ...
  return (
    <div className="p-8 max-w-2xl">
      ...
      <h1 className="text-2xl font-bold text-text-primary mb-6">New Challenge</h1>
